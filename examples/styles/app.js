...
`;
  ...
  // examples/styles/devtools-setup.ts
  installDevtools();

  // examples/styles/app.ts
  var COLORS = ["#2563eb", "#dc2626", "#16a34a", "#9333ea", "#ea580c"];
  var styleText = (bg) => `
  :host {
    display: block;
    padding: 28px;
...
`;
  var _reset_dec, _next_dec, _index_dec, _a, _ColorChanger_decorators, _init;
  _ColorChanger_decorators = [Component.define()];
  var ColorChanger = class extends (_a = Component("app-changer", { styles: styleText(COLORS[0]) }), _index_dec = [Component.prop()], _next_dec = [Component.event()], _reset_dec = [Component.event()], _a) {
    constructor() {
      super(...arguments);
      __runInitializers(_init, 5, this);
      __publicField(this, "index", __runInitializers(_init, 8, this, 0)), __runInitializers(_init, 11, this);
    }
    get color() {
  ...
  __decorateElement(_init, 1, "next", _next_dec, ColorChanger);
  __decorateElement(_init, 1, "reset", _reset_dec, ColorChanger);
  __decorateElement(_init, 5, "index", _index_dec, ColorChanger);
  ColorChanger = __decorateElement(_init, 0, "ColorChanger", _ColorChanger_decorators, ColorChanger);
  __runInitializers(_init, 1, ColorChanger);

  // examples/styles/client.ts
  mountDevtoolsPanel();
})();
