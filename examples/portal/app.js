...
`;
  ...
  // examples/portal/devtools-setup.ts
  installDevtools();

  // examples/portal/app.ts
  var _toggleVariant_dec, _confirm_dec, _close_dec, _show_dec, _danger_dec, _open_dec, _a, _PortalDemo_decorators, _init;
  _PortalDemo_decorators = [Component.define()];
  var PortalDemo = class extends (_a = Component("portal-demo"), _open_dec = [Component.prop()], _danger_dec = [Component.prop()], _show_dec = [Component.event()], _close_dec = [Component.event()], _confirm_dec = [Component.event()], _toggleVariant_dec = [Component.event()], _a) {
    constructor() {
      super(...arguments);
      __runInitializers(_init, 5, this);
      __publicField(this, "open", __runInitializers(_init, 8, this, false)), __runInitializers(_init, 11, this);
      __publicField(this, "danger", __runInitializers(_init, 12, this, false)), __runInitializers(_init, 15, this);
    }
    show() {
      this.open = true;
    }
        ...
        when(this.open, () => html`
          <div class="backdrop" @click=${this.close}>
            ...
            >
              ...
              <p>
                ${this.danger ? "This action cannot be undone." : "Are you sure you want to continue?"}
              </p>
              <div class="actions">
  ...
  __decorateElement(_init, 1, "show", _show_dec, PortalDemo);
  __decorateElement(_init, 1, "close", _close_dec, PortalDemo);
  __decorateElement(_init, 1, "confirm", _confirm_dec, PortalDemo);
  __decorateElement(_init, 1, "toggleVariant", _toggleVariant_dec, PortalDemo);
  __decorateElement(_init, 5, "open", _open_dec, PortalDemo);
  __decorateElement(_init, 5, "danger", _danger_dec, PortalDemo);
  PortalDemo = __decorateElement(_init, 0, "PortalDemo", _PortalDemo_decorators, PortalDemo);
  __publicField(PortalDemo, "styles", css`
  ...
  `);
  __runInitializers(_init, 1, PortalDemo);

  // examples/portal/client.ts
  mountDevtoolsPanel();
})();
