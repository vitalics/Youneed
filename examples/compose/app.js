...
`;
  ...
  function defineStylesView() {
    var _ctx_dec, _a6, _b, _init6, _highlight, _cleanup, _StylesViewImpl_instances, paintHighlight_fn, toggleHighlight_fn, rule_fn;
    ...
    }, _init6 = __decoratorStart(_a6), _highlight = new WeakMap(), _cleanup = new WeakMap(), _StylesViewImpl_instances = new WeakSet(), /** Draw (or clear) the on-page overlay for the current selection. */
    paintHighlight_fn = function() {
      this.ctx?.highlight(__privateGet(this, _highlight) ? this.ctx.current() : void 0);
    }, /** Toggle the persistent highlight; scroll the element into view when turning on. */
    toggleHighlight_fn = function() {
...
`;
  ...
  // examples/compose/devtools-setup.ts
  installDevtools();

  // examples/compose/app.ts
  var _tone_dec, _label_dec, _a, _Pill_decorators, _init;
  _Pill_decorators = [Component.define()];
  var Pill = class extends (_a = Component("x-pill", {
    styles: css`
    :host { display:inline-block; }
    b { background:#eef2ff; color:#4338ca; border-radius:999px; padding:2px 10px;
        font:600 13px system-ui; }
  `
  }), _label_dec = [Component.prop()], _tone_dec = [Component.prop()], _a) {
    constructor() {
      super(...arguments);
      __publicField(this, "label", __runInitializers(_init, 8, this, "")), __runInitializers(_init, 11, this);
      __publicField(this, "tone", __runInitializers(_init, 12, this, "#4338ca")), __runInitializers(_init, 15, this);
    }
    render() {
  ...
  __decorateElement(_init, 5, "label", _label_dec, Pill);
  __decorateElement(_init, 5, "tone", _tone_dec, Pill);
  Pill = __decorateElement(_init, 0, "Pill", _Pill_decorators, Pill);
  __runInitializers(_init, 1, Pill);
  var _tags_dec, _a2, _TagRow_decorators, _init2;
  _TagRow_decorators = [Component.define()];
  var TagRow = class extends (_a2 = Component("x-tagrow", {
    styles: css`:host{display:flex;gap:8px;align-items:center} span{color:#64748b;font:13px system-ui}`
  }), _tags_dec = [Component.prop()], _a2) {
    constructor() {
      super(...arguments);
      __publicField(this, "tags", __runInitializers(_init2, 8, this, ["new", "hot", "sale"])), __runInitializers(_init2, 11, this);
    }
    render() {
      return html`
      <span>in a hole →</span>
  ...
  __decorateElement(_init2, 5, "tags", _tags_dec, TagRow);
  TagRow = __decorateElement(_init2, 0, "TagRow", _TagRow_decorators, TagRow);
  __runInitializers(_init2, 1, TagRow);
  var _ok_dec, _a3, _StatusPill_decorators, _init3;
  _StatusPill_decorators = [Component.define()];
  var StatusPill = class extends (_a3 = Component("x-status"), _ok_dec = [Component.prop()], _a3) {
    constructor() {
      super(...arguments);
      __publicField(this, "ok", __runInitializers(_init3, 8, this, true)), __runInitializers(_init3, 11, this);
    }
    render() {
  ...
  __decorateElement(_init3, 5, "ok", _ok_dec, StatusPill);
  StatusPill = __decorateElement(_init3, 0, "StatusPill", _StatusPill_decorators, StatusPill);
  __runInitializers(_init3, 1, StatusPill);
  var _items_dec, _a4, _PillList_decorators, _init4;
  _PillList_decorators = [Component.define()];
  var PillList = class extends (_a4 = Component("x-pilllist", {
    styles: css`:host{display:flex;gap:6px;flex-wrap:wrap}`
  }), _items_dec = [Component.prop()], _a4) {
    constructor() {
      super(...arguments);
      __publicField(this, "items", __runInitializers(_init4, 8, this, [])), __runInitializers(_init4, 11, this);
    }
    render() {
  ...
  __decorateElement(_init4, 5, "items", _items_dec, PillList);
  PillList = __decorateElement(_init4, 0, "PillList", _PillList_decorators, PillList);
  __runInitializers(_init4, 1, PillList);
  var _add_dec, _toggle_dec, _people_dec, _ok_dec2, _a5, _ComposeRoot_decorators, _init5;
  _ComposeRoot_decorators = [Component.define()];
  var ComposeRoot = class extends (_a5 = Component("compose-root", {
    styles: css`
  ...
  `
  }), _ok_dec2 = [Component.prop()], _people_dec = [Component.prop()], _toggle_dec = [Component.event()], _add_dec = [Component.event()], _a5) {
    constructor() {
      super(...arguments);
      __runInitializers(_init5, 5, this);
      __publicField(this, "ok", __runInitializers(_init5, 8, this, true)), __runInitializers(_init5, 11, this);
      __publicField(this, "people", __runInitializers(_init5, 12, this, [
        { id: 1, name: "Ada" },
        { id: 2, name: "Grace" }
  ...
  __decorateElement(_init5, 1, "toggle", _toggle_dec, ComposeRoot);
  __decorateElement(_init5, 1, "add", _add_dec, ComposeRoot);
  __decorateElement(_init5, 5, "ok", _ok_dec2, ComposeRoot);
  __decorateElement(_init5, 5, "people", _people_dec, ComposeRoot);
  ComposeRoot = __decorateElement(_init5, 0, "ComposeRoot", _ComposeRoot_decorators, ComposeRoot);
  __runInitializers(_init5, 1, ComposeRoot);

  // examples/compose/client.ts
  mountDevtoolsPanel();
})();
