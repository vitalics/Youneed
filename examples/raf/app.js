...
`;
  ...
  function defineComponentTreeView() {
    var _ctx_dec, _a3, _b, _init3, _search, _collapsed, _frozen, _cleanup, _ComponentTreeViewImpl_instances, hl_fn, orderedEvents_fn, toggle_fn, rowOf_fn, detail_fn;
    return _b = class extends (_a3 = Component("dt-component-tree"), _ctx_dec = [Component.prop()], _a3) {
      constructor() {
        super(...arguments);
        __privateAdd(this, _ComponentTreeViewImpl_instances);
        __publicField(this, "ctx", __runInitializers(_init3, 8, this)), __runInitializers(_init3, 11, this);
    ...
    }, _init3 = __decoratorStart(_a3), _search = new WeakMap(), _collapsed = new WeakMap(), _frozen = new WeakMap(), _cleanup = new WeakMap(), _ComponentTreeViewImpl_instances = new WeakSet(), /** Highlight `rec` on the page — gated by this plugin's "highlight" toggle. */
    hl_fn = function(rec) {
    ...
    orderedEvents_fn = function(rec, ctx) {
      ...
      `;
    }, __decorateElement(_init3, 5, "ctx", _ctx_dec, _b), __decoratorMetadata(_init3, _b), __publicField(_b, "devtools", false), __publicField(_b, "styles", css`${TREE_CSS}`), _b;
  }
  ...
  function defineTimeTravelView() {
    var _ctx_dec, _a3, _b, _init3, _snap, _highlight, _cleanup, _TimeTravelViewImpl_instances, paintHighlight_fn, toggleHighlight_fn, apply_fn, goTo_fn;
    return _b = class extends (_a3 = Component("dt-time-travel"), _ctx_dec = [Component.prop()], _a3) {
      constructor() {
        super(...arguments);
    ...
    }, _init3 = __decoratorStart(_a3), _snap = new WeakMap(), _highlight = new WeakMap(), _cleanup = new WeakMap(), _TimeTravelViewImpl_instances = new WeakSet(), /** Draw (or clear) the on-page overlay for the current selection. */
    ...
    toggleHighlight_fn = function() {
      ...
      this.requestUpdate();
      __privateMethod(this, _TimeTravelViewImpl_instances, paintHighlight_fn).call(this);
    }, __decorateElement(_init3, 5, "ctx", _ctx_dec, _b), __decoratorMetadata(_init3, _b), __publicField(_b, "devtools", false), __publicField(_b, "styles", css`
  ...
  function defineStylesView() {
    var _ctx_dec, _a3, _b, _init3, _highlight, _cleanup, _editing, _editingSel, _StylesViewImpl_instances, paintHighlight_fn, toggleHighlight_fn, isEditing_fn, startEdit_fn, commitEdit_fn, commitRename_fn, startSelEdit_fn, commitSelector_fn, addRule_fn, addDecl_fn, rule_fn;
    return _b = class extends (_a3 = Component("dt-styles"), _ctx_dec = [Component.prop()], _a3) {
      constructor() {
        super(...arguments);
    ...
    }, _init3 = __decoratorStart(_a3), _highlight = new WeakMap(), _cleanup = new WeakMap(), _editing = new WeakMap(), _editingSel = new WeakMap(), _StylesViewImpl_instances = new WeakSet(), /** Draw (or clear) the on-page overlay for the current selection. */
    paintHighlight_fn = function() {
      this.ctx?.highlight(__privateGet(this, _highlight) ? this.ctx.current() : void 0);
    }, /** Toggle the persistent highlight; scroll the element into view when turning on. */
    toggleHighlight_fn = function() {
...
`;
  ...
  // examples/raf/devtools-setup.ts
  installDevtools();
...
`;
  ...
  function startBall(self) {
    ...
    self.onFrame((dt) => {
      ...
      if (bounced) self.bounces++;
      draw(self.x, self.y);
    });
  }
  var _bounces_dec, _a, _SmoothBall_decorators, _init;
  _SmoothBall_decorators = [Component.define()];
  var SmoothBall = class extends (_a = Component("smooth-ball", { scheduler: createFpsScheduler(60) }), _bounces_dec = [Component.prop()], _a) {
    constructor() {
      super(...arguments);
      __publicField(this, "x", 40);
      __publicField(this, "y", 30);
      __publicField(this, "vx", 150);
      __publicField(this, "vy", 105);
      __publicField(this, "bounces", __runInitializers(_init, 8, this, 0)), __runInitializers(_init, 11, this);
    }
    onMount() {
      startBall(this);
    }
  ...
  __decorateElement(_init, 5, "bounces", _bounces_dec, SmoothBall);
  SmoothBall = __decorateElement(_init, 0, "SmoothBall", _SmoothBall_decorators, SmoothBall);
  __publicField(SmoothBall, "styles", ballStyles);
  __runInitializers(_init, 1, SmoothBall);
  var _bounces_dec2, _a2, _ChoppyBall_decorators, _init2;
  _ChoppyBall_decorators = [Component.define()];
  var ChoppyBall = class extends (_a2 = Component("choppy-ball", { scheduler: createFpsScheduler(8) }), _bounces_dec2 = [Component.prop()], _a2) {
    constructor() {
      super(...arguments);
      __publicField(this, "x", 40);
      __publicField(this, "y", 30);
      __publicField(this, "vx", 150);
      __publicField(this, "vy", 105);
      __publicField(this, "bounces", __runInitializers(_init2, 8, this, 0)), __runInitializers(_init2, 11, this);
    }
    onMount() {
      startBall(this);
    }
  ...
  __decorateElement(_init2, 5, "bounces", _bounces_dec2, ChoppyBall);
  ChoppyBall = __decorateElement(_init2, 0, "ChoppyBall", _ChoppyBall_decorators, ChoppyBall);
  __publicField(ChoppyBall, "styles", ballStyles);
  __runInitializers(_init2, 1, ChoppyBall);

  // examples/raf/client.ts
  mountDevtoolsPanel();
})();
