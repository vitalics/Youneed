...
`;
  ...
  // examples/task-restart/devtools-setup.ts
  installDevtools();

  // examples/task-restart/app.ts
...
`;
  var _bump_dec, _toggle_dec, _onCount_dec, _running_dec, _laps_dec, _threshold_dec, _count_dec, _a, _RestartCounter_decorators, _init;
  _RestartCounter_decorators = [Component.define()];
  var RestartCounter = class extends (_a = Component("restart-counter", { styles: STYLES }), _count_dec = [Component.prop()], _threshold_dec = [Component.prop()], _laps_dec = [Component.prop()], _running_dec = [Component.prop()], _onCount_dec = [Component.watch("count")], _toggle_dec = [Component.event()], _bump_dec = [Component.event()], _a) {
    constructor() {
      super(...arguments);
      __runInitializers(_init, 5, this);
      __publicField(this, "count", __runInitializers(_init, 8, this, 0)), __runInitializers(_init, 11, this);
      __publicField(this, "threshold", __runInitializers(_init, 12, this, 5)), __runInitializers(_init, 15, this);
      __publicField(this, "laps", __runInitializers(_init, 16, this, 0)), __runInitializers(_init, 19, this);
      __publicField(this, "running", __runInitializers(_init, 20, this, true)), __runInitializers(_init, 23, this);
      ...
      __publicField(this, "tick", task(this, async (signal) => {
      ...
      <div class="row">
        ...
        <label>
          ...
          <input
            ...
            @input=${(e) => this.threshold = Math.max(1, Number(e.target.value) || 1)}
            style="width:56px"
          />
        </label>
      </div>
  ...
  __decorateElement(_init, 1, "onCount", _onCount_dec, RestartCounter);
  __decorateElement(_init, 1, "toggle", _toggle_dec, RestartCounter);
  __decorateElement(_init, 1, "bump", _bump_dec, RestartCounter);
  __decorateElement(_init, 5, "count", _count_dec, RestartCounter);
  __decorateElement(_init, 5, "threshold", _threshold_dec, RestartCounter);
  __decorateElement(_init, 5, "laps", _laps_dec, RestartCounter);
  __decorateElement(_init, 5, "running", _running_dec, RestartCounter);
  RestartCounter = __decorateElement(_init, 0, "RestartCounter", _RestartCounter_decorators, RestartCounter);
  __runInitializers(_init, 1, RestartCounter);

  // examples/task-restart/client.ts
  mountDevtoolsPanel();
})();
