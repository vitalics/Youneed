...
`;
  ...
  // examples/router-slash/devtools-setup.ts
  installDevtools();
  ...
  function createRouter(options) {
    ...
    const compiled = options.routes.map((r) => {
      ...
      return { ...r, regex: rx, paramNames: rx.paramNames };
    });
    let current;
    let mounted;
    ...
    function render() {
      ...
      if (!mounted || mounted.tag !== route.component) {
        mounted?.el.remove();
        const el2 = document.createElement(route.component);
        el2.params = params;
        el2.query = query;
        options.outlet.replaceChildren(el2);
        mounted = { tag: route.component, el: el2 };
      } else {
...
`;
  var _HomePage_decorators, _init, _a;
  _HomePage_decorators = [Component.define()];
  var HomePage = class extends (_a = Component("home-page", { styles: pageStyles })) {
    render() {
      return html`
      <h2>🏠 Home</h2>
  ...
  HomePage = __decorateElement(_init, 0, "HomePage", _HomePage_decorators, HomePage);
  __runInitializers(_init, 1, HomePage);
  var _query_dec, _params_dec, _a2, _UserPage_decorators, _init2;
  _UserPage_decorators = [Component.define()];
  var UserPage = class extends (_a2 = Component("user-page", { styles: pageStyles }), _params_dec = [Component.prop()], _query_dec = [Component.prop()], _a2) {
    constructor() {
      super(...arguments);
      __publicField(this, "params", __runInitializers(_init2, 8, this, {})), __runInitializers(_init2, 11, this);
      __publicField(this, "query", __runInitializers(_init2, 12, this, {})), __runInitializers(_init2, 15, this);
    }
    render() {
      return html`
  ...
  __decorateElement(_init2, 5, "params", _params_dec, UserPage);
  __decorateElement(_init2, 5, "query", _query_dec, UserPage);
  UserPage = __decorateElement(_init2, 0, "UserPage", _UserPage_decorators, UserPage);
  __runInitializers(_init2, 1, UserPage);
  var _params_dec2, _a3, _FilesPage_decorators, _init3;
  _FilesPage_decorators = [Component.define()];
  var FilesPage = class extends (_a3 = Component("files-page", { styles: pageStyles }), _params_dec2 = [Component.prop()], _a3) {
    constructor() {
      super(...arguments);
      __publicField(this, "params", __runInitializers(_init3, 8, this, {})), __runInitializers(_init3, 11, this);
    }
    render() {
  ...
  __decorateElement(_init3, 5, "params", _params_dec2, FilesPage);
  FilesPage = __decorateElement(_init3, 0, "FilesPage", _FilesPage_decorators, FilesPage);
  __runInitializers(_init3, 1, FilesPage);
  var _params_dec3, _a4, _NotFound_decorators, _init4;
  _NotFound_decorators = [Component.define()];
  var NotFound = class extends (_a4 = Component("not-found", { styles: pageStyles }), _params_dec3 = [Component.prop()], _a4) {
    constructor() {
      super(...arguments);
      __publicField(this, "params", __runInitializers(_init4, 8, this, {})), __runInitializers(_init4, 11, this);
    }
    render() {
  ...
  __decorateElement(_init4, 5, "params", _params_dec3, NotFound);
  NotFound = __decorateElement(_init4, 0, "NotFound", _NotFound_decorators, NotFound);
  __runInitializers(_init4, 1, NotFound);
  var _RouterApp_decorators, _init5, _a5;
  _RouterApp_decorators = [Component.define()];
  var RouterApp = class extends (_a5 = Component("router-app")) {
    #router;
    onMount() {
  ...
  RouterApp = __decorateElement(_init5, 0, "RouterApp", _RouterApp_decorators, RouterApp);
  __runInitializers(_init5, 1, RouterApp);

  // examples/router-slash/client.ts
  mountDevtoolsPanel();
})();
