...
`;
  ...
  // examples/priority/devtools-setup.ts
  installDevtools();

  // examples/priority/app.ts
  function busyWait(ms) {
    const end = performance.now() + ms;
    while (performance.now() < end) {
    }
  }
  var RENDER_COST_MS = 6;
...
`;
  function renderHeavy(self, title, accent, prio) {
    self.renders++;
    busyWait(RENDER_COST_MS);
    const skipped = self.tick - self.lastTick;
  ...
  var _tick_dec, _a, _BlockingWidget_decorators, _init;
  _BlockingWidget_decorators = [Component.define()];
  var BlockingWidget = class extends (_a = Component("blocking-widget", {
    priority: "render-blocking",
    styles: widgetStyles
  }), _tick_dec = [Component.prop()], _a) {
    constructor() {
      super(...arguments);
      __publicField(this, "tick", __runInitializers(_init, 8, this, 0)), __runInitializers(_init, 11, this);
  ...
  __decorateElement(_init, 5, "tick", _tick_dec, BlockingWidget);
  BlockingWidget = __decorateElement(_init, 0, "BlockingWidget", _BlockingWidget_decorators, BlockingWidget);
  __runInitializers(_init, 1, BlockingWidget);
  var _tick_dec2, _a2, _BackgroundWidget_decorators, _init2;
  _BackgroundWidget_decorators = [Component.define()];
  var BackgroundWidget = class extends (_a2 = Component("background-widget", {
    priority: "background",
    styles: widgetStyles
  }), _tick_dec2 = [Component.prop()], _a2) {
    constructor() {
      super(...arguments);
      __publicField(this, "tick", __runInitializers(_init2, 8, this, 0)), __runInitializers(_init2, 11, this);
      __publicField(this, "renders", 0);
      __publicField(this, "lastTick", 0);
    }
    render() {
  ...
  __decorateElement(_init2, 5, "tick", _tick_dec2, BackgroundWidget);
  BackgroundWidget = __decorateElement(_init2, 0, "BackgroundWidget", _BackgroundWidget_decorators, BackgroundWidget);
  __runInitializers(_init2, 1, BackgroundWidget);
  var rootStyles = css`
  :host {
    display: block;
...
`;
  var _toggle_dec, _fps_dec, _flooding_dec, _tick_dec3, _a3, _PriorityRoot_decorators, _init3, _rafId, _channel;
  _PriorityRoot_decorators = [Component.define()];
  var PriorityRoot = class extends (_a3 = Component("priority-demo", { styles: rootStyles }), _tick_dec3 = [Component.prop()], _flooding_dec = [Component.prop()], _fps_dec = [Component.prop()], _toggle_dec = [Component.event()], _a3) {
    constructor() {
      super(...arguments);
      __runInitializers(_init3, 5, this);
      __publicField(this, "tick", __runInitializers(_init3, 8, this, 0)), __runInitializers(_init3, 11, this);
      __publicField(this, "flooding", __runInitializers(_init3, 12, this, false)), __runInitializers(_init3, 15, this);
      __publicField(this, "fps", __runInitializers(_init3, 16, this, 0)), __runInitializers(_init3, 19, this);
    ...
    onMount() {
      ...
      const beat = () => {
        ...
        if (now - last >= 500) {
          this.fps = Math.round(frames * 1e3 / (now - last));
          frames = 0;
          last = now;
        }
        __privateSet(this, _rafId, requestAnimationFrame(beat));
      };
      beat();
      this.onCleanup(() => cancelAnimationFrame(__privateGet(this, _rafId)));
    ...
    start() {
      ...
      this.flooding = true;
      const ch = __privateSet(this, _channel, new MessageChannel());
      ch.port1.onmessage = () => {
        if (!this.flooding) return;
        this.tick++;
      ...
      ch.port2.postMessage(0);
      window.setTimeout(() => this.stop(), 4e3);
    }
    stop() {
      this.flooding = false;
      __privateGet(this, _channel)?.port1.close();
      __privateGet(this, _channel)?.port2.close();
  ...
  __decorateElement(_init3, 1, "toggle", _toggle_dec, PriorityRoot);
  __decorateElement(_init3, 5, "tick", _tick_dec3, PriorityRoot);
  __decorateElement(_init3, 5, "flooding", _flooding_dec, PriorityRoot);
  __decorateElement(_init3, 5, "fps", _fps_dec, PriorityRoot);
  PriorityRoot = __decorateElement(_init3, 0, "PriorityRoot", _PriorityRoot_decorators, PriorityRoot);
  __runInitializers(_init3, 1, PriorityRoot);

  // examples/priority/client.ts
  mountDevtoolsPanel();
})();
