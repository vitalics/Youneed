...
(() => {
  ...
  Component.define = function(when2) {
  ...
  function task(host, fn, options) {
    ...
    return {
      ...
      run(...args) {
        ...
        return Promise.resolve(fn(...args, mine.signal)).then((value) => {
...
`;
  ...
  function defineComponentTreeView() {
    var _ctx_dec, _a9, _b, _init9, _search, _collapsed, _frozen, _cleanup, _ComponentTreeViewImpl_instances, hl_fn, orderedEvents_fn, toggle_fn, rowOf_fn, detail_fn;
    return _b = class extends (_a9 = Component("dt-component-tree"), _ctx_dec = [Component.prop()], _a9) {
      constructor() {
        super(...arguments);
        __privateAdd(this, _ComponentTreeViewImpl_instances);
        __publicField(this, "ctx", __runInitializers(_init9, 8, this)), __runInitializers(_init9, 11, this);
    ...
    }, _init9 = __decoratorStart(_a9), _search = new WeakMap(), _collapsed = new WeakMap(), _frozen = new WeakMap(), _cleanup = new WeakMap(), _ComponentTreeViewImpl_instances = new WeakSet(), /** Highlight `rec` on the page — gated by this plugin's "highlight" toggle. */
    hl_fn = function(rec) {
    ...
    orderedEvents_fn = function(rec, ctx) {
      ...
      `;
    }, __decorateElement(_init9, 5, "ctx", _ctx_dec, _b), __decoratorMetadata(_init9, _b), __publicField(_b, "devtools", false), __publicField(_b, "styles", css`${TREE_CSS}`), _b;
  }
  ...
  function defineTimeTravelView() {
    var _ctx_dec, _a9, _b, _init9, _snap, _highlight, _cleanup, _TimeTravelViewImpl_instances, paintHighlight_fn, toggleHighlight_fn, apply_fn, goTo_fn;
    return _b = class extends (_a9 = Component("dt-time-travel"), _ctx_dec = [Component.prop()], _a9) {
      constructor() {
        super(...arguments);
    ...
    }, _init9 = __decoratorStart(_a9), _snap = new WeakMap(), _highlight = new WeakMap(), _cleanup = new WeakMap(), _TimeTravelViewImpl_instances = new WeakSet(), /** Draw (or clear) the on-page overlay for the current selection. */
    ...
    toggleHighlight_fn = function() {
      ...
      this.requestUpdate();
      __privateMethod(this, _TimeTravelViewImpl_instances, paintHighlight_fn).call(this);
    }, __decorateElement(_init9, 5, "ctx", _ctx_dec, _b), __decoratorMetadata(_init9, _b), __publicField(_b, "devtools", false), __publicField(_b, "styles", css`
  ...
  function defineStylesView() {
    var _ctx_dec, _a9, _b, _init9, _highlight, _cleanup, _StylesViewImpl_instances, paintHighlight_fn, toggleHighlight_fn, rule_fn;
    return _b = class extends (_a9 = Component("dt-styles"), _ctx_dec = [Component.prop()], _a9) {
      constructor() {
        super(...arguments);
    ...
    }, _init9 = __decoratorStart(_a9), _highlight = new WeakMap(), _cleanup = new WeakMap(), _StylesViewImpl_instances = new WeakSet(), /** Draw (or clear) the on-page overlay for the current selection. */
    paintHighlight_fn = function() {
      this.ctx?.highlight(__privateGet(this, _highlight) ? this.ctx.current() : void 0);
    }, /** Toggle the persistent highlight; scroll the element into view when turning on. */
    toggleHighlight_fn = function() {
      ...
      ${decls.map((decl) => {
        ...
        return html`
          <label class=${overridden ? "decl over" : on ? "decl" : "decl off"}>
            <input
              type="checkbox"
              class="cssck"
              .checked=${on}
...
`;
  ...
  // examples/dom/bin-dom.ts
  var Logger = class extends HTMLElement {
    log(...args) {
      const tag = this.constructor.tagName ?? "?";
      console.log(`[${tag}]`, ...args);
    }
  };
  var Highlighted = class extends HTMLElement {
    static styles = css`
    :host {
      background: yellow;
      display: block;
  ...
  var _MyText_decorators, _init, _a;
  _MyText_decorators = [Component.define()];
  var MyText = class extends (_a = Component("app-text", {
    base: Highlighted,
  ...
  MyText = __decorateElement(_init, 0, "MyText", _MyText_decorators, MyText);
  __runInitializers(_init, 1, MyText);
  var _reset_dec, _label_dec, _count_dec, _a2, _TickerComponent_decorators, _init2;
  _TickerComponent_decorators = [Component.define()];
  var TickerComponent = class extends (_a2 = Component("app-ticker"), _count_dec = [Component.prop()], _label_dec = [Component.prop()], _reset_dec = [Component.event()], _a2) {
    constructor() {
      super(...arguments);
      __runInitializers(_init2, 5, this);
      __publicField(this, "count", __runInitializers(_init2, 8, this, 0)), __runInitializers(_init2, 11, this);
      __publicField(this, "label", __runInitializers(_init2, 12, this)), __runInitializers(_init2, 15, this);
    }
    onMount() {
      const timer = setInterval(() => this.advance(), 1e3);
  ...
  __decorateElement(_init2, 1, "reset", _reset_dec, TickerComponent);
  __decorateElement(_init2, 5, "count", _count_dec, TickerComponent);
  __decorateElement(_init2, 5, "label", _label_dec, TickerComponent);
  TickerComponent = __decorateElement(_init2, 0, "TickerComponent", _TickerComponent_decorators, TickerComponent);
  __runInitializers(_init2, 1, TickerComponent);
  var _n_dec, _a3, _BadgeComponent_decorators, _init3;
  _BadgeComponent_decorators = [Component.define()];
  var BadgeComponent = class extends (_a3 = Component("app-badge", { priority: "background" }), _n_dec = [Component.prop({ type: Number })], _a3) {
    constructor() {
      super(...arguments);
      __publicField(this, "n", __runInitializers(_init3, 8, this, 0)), __runInitializers(_init3, 11, this);
    }
    render() {
  ...
  __decorateElement(_init3, 5, "n", _n_dec, BadgeComponent);
  BadgeComponent = __decorateElement(_init3, 0, "BadgeComponent", _BadgeComponent_decorators, BadgeComponent);
  __runInitializers(_init3, 1, BadgeComponent);
  var _StatsComponent_decorators, _init4, _a4;
  _StatsComponent_decorators = [Component.define()];
  var StatsComponent = class extends (_a4 = Component("app-stats")) {
    refresh = this.task(
      async (signal) => {
      ...
      { priority: "background" }
      // <- the developer just marks it background
    );
    onMount() {
      this.refresh.run();
      const id = setInterval(() => this.refresh.run(), 5e3);
  ...
  StatsComponent = __decorateElement(_init4, 0, "StatsComponent", _StatsComponent_decorators, StatsComponent);
  __runInitializers(_init4, 1, StatsComponent);
  var _width_dec, _y_dec, _x_dec, _a5, _PointerComponent_decorators, _init5;
  _PointerComponent_decorators = [Component.define()];
  var PointerComponent = class extends (_a5 = Component("app-pointer", { scheduler: rafScheduler }), _x_dec = [Component.prop()], _y_dec = [Component.prop()], _width_dec = [Component.prop()], _a5) {
    constructor() {
      super(...arguments);
      __publicField(this, "x", __runInitializers(_init5, 8, this, 0)), __runInitializers(_init5, 11, this);
      __publicField(this, "y", __runInitializers(_init5, 12, this, 0)), __runInitializers(_init5, 15, this);
      __publicField(this, "width", __runInitializers(_init5, 16, this, 0)), __runInitializers(_init5, 19, this);
    }
    onMount() {
  ...
  __decorateElement(_init5, 5, "x", _x_dec, PointerComponent);
  __decorateElement(_init5, 5, "y", _y_dec, PointerComponent);
  __decorateElement(_init5, 5, "width", _width_dec, PointerComponent);
  PointerComponent = __decorateElement(_init5, 0, "PointerComponent", _PointerComponent_decorators, PointerComponent);
  __runInitializers(_init5, 1, PointerComponent);
  var _reverse_dec, _add_dec, _setFilter_dec, _filter_dec, _items_dec, _a6, _TodosComponent_decorators, _init6, _nextId;
  _TodosComponent_decorators = [Component.define()];
  var TodosComponent = class extends (_a6 = Component("app-todos"), _items_dec = [Component.prop()], _filter_dec = [Component.prop()], _setFilter_dec = [Component.event()], _add_dec = [Component.event()], _reverse_dec = [Component.event()], _a6) {
    constructor() {
      super(...arguments);
      __runInitializers(_init6, 5, this);
      __publicField(this, "items", __runInitializers(_init6, 8, this, [
      ...
      __publicField(this, "filter", __runInitializers(_init6, 12, this, "all")), __runInitializers(_init6, 15, this);
      __privateAdd(this, _nextId, 4);
    }
    ...
    render() {
      ...
      ${when(
        ...
        () => html`<ul>
          ...
          this.visible,
          (t) => t.id,
          // stable key → keyed reconciliation
  ...
  _nextId = new WeakMap();
  __decorateElement(_init6, 1, "setFilter", _setFilter_dec, TodosComponent);
  __decorateElement(_init6, 1, "add", _add_dec, TodosComponent);
  __decorateElement(_init6, 1, "reverse", _reverse_dec, TodosComponent);
  __decorateElement(_init6, 5, "items", _items_dec, TodosComponent);
  __decorateElement(_init6, 5, "filter", _filter_dec, TodosComponent);
  TodosComponent = __decorateElement(_init6, 0, "TodosComponent", _TodosComponent_decorators, TodosComponent);
  __publicField(TodosComponent, "styles", css`
  ...
  `);
  __runInitializers(_init6, 1, TodosComponent);
  var _SlowComponent_decorators, _init7, _a7;
  _SlowComponent_decorators = [Component.define()];
  var SlowComponent = class extends (_a7 = Component("app-slow")) {
    static styles = css`
    :host { display: block; font: 14px/1.5 system-ui, sans-serif; }
  ...
  `;
    ...
    slow = this.task(
      (signal) => new Promise((resolve, reject) => {
        const id = setTimeout(() => resolve("✅ data (after 8s)"), 8e3);
    ...
    render() {
      const t = this.slow;
      const status = t.pending ? html`<span class="pending">loading… (8s — hit Abort or unmount me)</span>` : t.aborted ? html`<span class="aborted">aborted ✕</span>` : t.error ? html`<span class="aborted">error</span>` : html`<span class="done">${t.value ?? "idle"}</span>`;
      return html`
  ...
  SlowComponent = __decorateElement(_init7, 0, "SlowComponent", _SlowComponent_decorators, SlowComponent);
  __runInitializers(_init7, 1, SlowComponent);
  var _onCountChange_dec, _onClick_dec, _onNameChange_dec, _shout_dec, _pings_dec, _shared_dec, _clicks_dec, _name_dec, _a8, _init8;
  var RootComponent = class extends (_a8 = Component("app-root", { base: Logger }), _name_dec = [Component.prop()], _clicks_dec = [Component.prop()], _shared_dec = [Component.prop()], _pings_dec = [Component.prop()], _shout_dec = [Component.computed()], _onNameChange_dec = [Component.watch("name")], _onClick_dec = [Component.event()], _onCountChange_dec = [Component.event()], _a8) {
    constructor() {
      super(...arguments);
      __runInitializers(_init8, 5, this);
      __publicField(this, "name", __runInitializers(_init8, 8, this, "hello")), __runInitializers(_init8, 11, this);
      __publicField(this, "clicks", __runInitializers(_init8, 12, this, 0)), __runInitializers(_init8, 15, this);
      __publicField(this, "shared", __runInitializers(_init8, 16, this, 10)), __runInitializers(_init8, 19, this);
      __publicField(this, "pings", __runInitializers(_init8, 20, this, 0)), __runInitializers(_init8, 23, this);
      // Typed task: `this.load.run(name)` and `this.load.pending` autocomplete.
      __publicField(this, "load", this.task(async (prop, signal) => {
    ...
    onNameChange(next, prev) {
      this.log(`name: ${prev} -> ${next}`);
    }
    onClick() {
      this.clicks++;
      this.emit("count", this.clicks);
      this.load.run(this.name);
    }
    onCountChange(event) {
      this.shared = event.detail;
    }
    // Lifecycle hooks.
    onMount() {
      this.log("mounted");
  ...
  __decorateElement(_init8, 2, "shout", _shout_dec, RootComponent);
  __decorateElement(_init8, 1, "onNameChange", _onNameChange_dec, RootComponent);
  __decorateElement(_init8, 1, "onClick", _onClick_dec, RootComponent);
  __decorateElement(_init8, 1, "onCountChange", _onCountChange_dec, RootComponent);
  __decorateElement(_init8, 5, "name", _name_dec, RootComponent);
  __decorateElement(_init8, 5, "clicks", _clicks_dec, RootComponent);
  __decorateElement(_init8, 5, "shared", _shared_dec, RootComponent);
  __decorateElement(_init8, 5, "pings", _pings_dec, RootComponent);
  __decoratorMetadata(_init8, RootComponent);
  function bootstrap() {
    installDevtools();
