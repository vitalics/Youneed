...
function hydrate(root = document) {
  for (const script of root.querySelectorAll("script[data-hydrate]")) {
    ...
    for (const el2 of root.querySelectorAll(payload.tag)) {
      Object.assign(el2, payload.props);
    }
  }
}
...
// examples/crud/view.ts
var _user_dec, _a, _UserView_decorators, _init;
_UserView_decorators = [Component.define()];
var UserView = class extends (_a = Component("user-view", {
  styles: css`
  ...
  `
}), _user_dec = [Component.prop()], _a) {
  constructor() {
    super(...arguments);
    __publicField(this, "user", __runInitializers(_init, 8, this)), __runInitializers(_init, 11, this);
  }
  render() {
    return html`
...
__decorateElement(_init, 5, "user", _user_dec, UserView);
UserView = __decorateElement(_init, 0, "UserView", _UserView_decorators, UserView);
__runInitializers(_init, 1, UserView);
