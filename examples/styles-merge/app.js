...
(() => {
  ...
  // examples/styles-merge/lazy.css
  var require_lazy = __commonJS({
    "examples/styles-merge/lazy.css"(exports, module) {
      module.exports = '/* Layer 3 — lazy `() => import()`. Adopted LAST → wins the :host background. */\n:host { background: #dcfce7; }                     /* green bg (final winner) */\n.lazy-only { display: block; color: #166534; }     /* reveals the line hidden by layer 2 */\n.badge::after { content: " · lazy applied ✓"; color: #166534; }\n';
    }
  });
...
`;
  ...
  // examples/styles-merge/devtools-setup.ts
  installDevtools();

  // examples/styles-merge/options.css
  var options_default = "/* Layer 1 — Component options `styles` (imported as text). Adopted FIRST. */\n:host { display: block; background: #e0e7ff; padding: 24px; } /* indigo bg (loses) · unique: padding */\n.label { color: #4338ca; font-weight: 700; }\n";

  // examples/styles-merge/app.ts
  var _StyleMerge_decorators, _init, _a;
  _StyleMerge_decorators = [Component.define()];
  var StyleMerge = class extends (_a = Component("style-merge", {
    // Layer 1: a CSS string passed via the options — adopted first.
    styles: options_default
  })) {
    ...
    `,
      ...
      () => Promise.resolve().then(() => __toESM(require_lazy(), 1))
    ];
    onMount() {
  ...
  StyleMerge = __decorateElement(_init, 0, "StyleMerge", _StyleMerge_decorators, StyleMerge);
  __runInitializers(_init, 1, StyleMerge);

  // examples/styles-merge/client.ts
  mountDevtoolsPanel();
})();
