...
function defineComponentTreeView() {
  var _ctx_dec, _a4, _b, _init4, _search, _collapsed, _frozen, _cleanup, _ComponentTreeViewImpl_instances, hl_fn, orderedEvents_fn, toggle_fn, rowOf_fn, detail_fn;
  return _b = class extends (_a4 = Component("dt-component-tree"), _ctx_dec = [Component.prop()], _a4) {
    constructor() {
      super(...arguments);
      __privateAdd(this, _ComponentTreeViewImpl_instances);
      __publicField(this, "ctx", __runInitializers(_init4, 8, this)), __runInitializers(_init4, 11, this);
  ...
  }, _init4 = __decoratorStart(_a4), _search = new WeakMap(), _collapsed = new WeakMap(), _frozen = new WeakMap(), _cleanup = new WeakMap(), _ComponentTreeViewImpl_instances = new WeakSet(), /** Highlight `rec` on the page — gated by this plugin's "highlight" toggle. */
  hl_fn = function(rec) {
  ...
  orderedEvents_fn = function(rec, ctx) {
    ...
    return html`
      ...
      `;
  }, __decorateElement(_init4, 5, "ctx", _ctx_dec, _b), __decoratorMetadata(_init4, _b), __publicField(_b, "devtools", false), __publicField(_b, "styles", css`${TREE_CSS}`), _b;
}
...
function defineTimeTravelView() {
  var _ctx_dec, _a4, _b, _init4, _snap, _highlight, _cleanup, _TimeTravelViewImpl_instances, paintHighlight_fn, toggleHighlight_fn, apply_fn, goTo_fn;
  return _b = class extends (_a4 = Component("dt-time-travel"), _ctx_dec = [Component.prop()], _a4) {
    constructor() {
      super(...arguments);
  ...
  }, _init4 = __decoratorStart(_a4), _snap = new WeakMap(), _highlight = new WeakMap(), _cleanup = new WeakMap(), _TimeTravelViewImpl_instances = new WeakSet(), /** Draw (or clear) the on-page overlay for the current selection. */
  ...
  toggleHighlight_fn = function() {
    ...
    this.requestUpdate();
    __privateMethod(this, _TimeTravelViewImpl_instances, paintHighlight_fn).call(this);
  }, __decorateElement(_init4, 5, "ctx", _ctx_dec, _b), __decoratorMetadata(_init4, _b), __publicField(_b, "devtools", false), __publicField(_b, "styles", css`
...
function defineStylesView() {
  var _ctx_dec, _a4, _b, _init4, _highlight, _cleanup, _StylesViewImpl_instances, paintHighlight_fn, toggleHighlight_fn, rule_fn;
  return _b = class extends (_a4 = Component("dt-styles"), _ctx_dec = [Component.prop()], _a4) {
    constructor() {
      super(...arguments);
  ...
  }, _init4 = __decoratorStart(_a4), _highlight = new WeakMap(), _cleanup = new WeakMap(), _StylesViewImpl_instances = new WeakSet(), /** Draw (or clear) the on-page overlay for the current selection. */
  paintHighlight_fn = function() {
    this.ctx?.highlight(__privateGet(this, _highlight) ? this.ctx.current() : void 0);
  }, /** Toggle the persistent highlight; scroll the element into view when turning on. */
  toggleHighlight_fn = function() {
...
function pageDevtoolsPanels() {
  return [pagePanel(), routesPanel(), mapPanel()];
}
...
// examples/video/components.ts
function trackTime(host, v, signal) {
  let raf = 0;
  const tick = () => {
    const t = Math.round(v.currentTime * 10) / 10;
    if (t !== host.time) host.time = t;
    if (host.playing === v.paused) host.playing = !v.paused;
...
`;
var _toggle_dec, _time_dec, _playing_dec, _a, _SlotVideo_decorators, _init, _SlotVideo_instances, video_fn;
_SlotVideo_decorators = [Component.define(3e3)];
var SlotVideo = class extends (_a = Component("slot-video"), _playing_dec = [Component.prop()], _time_dec = [Component.prop()], _toggle_dec = [Component.event()], _a) {
  constructor() {
    super(...arguments);
    __runInitializers(_init, 5, this);
    __privateAdd(this, _SlotVideo_instances);
    __publicField(this, "playing", __runInitializers(_init, 8, this, false)), __runInitializers(_init, 11, this);
    __publicField(this, "time", __runInitializers(_init, 12, this, 0)), __runInitializers(_init, 15, this);
  }
  onMount() {
    this.setAttribute("data-hydrated", "");
    const v = __privateMethod(this, _SlotVideo_instances, video_fn).call(this);
    if (v) trackTime(this, v, this.signal);
  }
  toggle() {
    const v = __privateMethod(this, _SlotVideo_instances, video_fn).call(this);
...
_SlotVideo_instances = new WeakSet();
video_fn = function() {
  return this.querySelector("video");
};
__decorateElement(_init, 1, "toggle", _toggle_dec, SlotVideo);
__decorateElement(_init, 5, "playing", _playing_dec, SlotVideo);
__decorateElement(_init, 5, "time", _time_dec, SlotVideo);
SlotVideo = __decorateElement(_init, 0, "SlotVideo", _SlotVideo_decorators, SlotVideo);
__publicField(SlotVideo, "styles", BAR);
__runInitializers(_init, 1, SlotVideo);
var _toggle_dec2, _time_dec2, _playing_dec2, _src_dec, _a2, _ShadowVideo_decorators, _init2, _ShadowVideo_instances, video_fn2;
_ShadowVideo_decorators = [Component.define(3e3)];
var ShadowVideo = class extends (_a2 = Component("shadow-video"), _src_dec = [Component.prop({ attribute: true })], _playing_dec2 = [Component.prop()], _time_dec2 = [Component.prop()], _toggle_dec2 = [Component.event()], _a2) {
  constructor() {
    super(...arguments);
    __runInitializers(_init2, 5, this);
    __privateAdd(this, _ShadowVideo_instances);
    __publicField(this, "src", __runInitializers(_init2, 8, this, "")), __runInitializers(_init2, 11, this);
    __publicField(this, "playing", __runInitializers(_init2, 12, this, false)), __runInitializers(_init2, 15, this);
    __publicField(this, "time", __runInitializers(_init2, 16, this, 0)), __runInitializers(_init2, 19, this);
  }
  onMount() {
    this.setAttribute("data-hydrated", "");
    const v = __privateMethod(this, _ShadowVideo_instances, video_fn2).call(this);
    if (v) trackTime(this, v, this.signal);
  }
  toggle() {
    const v = __privateMethod(this, _ShadowVideo_instances, video_fn2).call(this);
...
_ShadowVideo_instances = new WeakSet();
video_fn2 = function() {
  return this.shadowRoot.querySelector("video");
};
__decorateElement(_init2, 1, "toggle", _toggle_dec2, ShadowVideo);
__decorateElement(_init2, 5, "src", _src_dec, ShadowVideo);
__decorateElement(_init2, 5, "playing", _playing_dec2, ShadowVideo);
__decorateElement(_init2, 5, "time", _time_dec2, ShadowVideo);
ShadowVideo = __decorateElement(_init2, 0, "ShadowVideo", _ShadowVideo_decorators, ShadowVideo);
__publicField(ShadowVideo, "styles", BAR);
__runInitializers(_init2, 1, ShadowVideo);
var SAMPLE = "https://www.w3schools.com/tags/mov_bbb.mp4";
var _VideoLab_decorators, _init3, _a3;
_VideoLab_decorators = [Component.define("server")];
var VideoLab = class extends (_a3 = Component("video-lab")) {
  static styles = css`
    :host {
      display: block;
      max-width: 920px;
...
VideoLab = __decorateElement(_init3, 0, "VideoLab", _VideoLab_decorators, VideoLab);
__runInitializers(_init3, 1, VideoLab);

// examples/video/client.ts
installDevtools();
installPageDevtools();
